                ...
                <div class="flex-1 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/50 p-6">
                        <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                            <span
                                class="w-6 h-6 bg-orange-500 rounded-full text-white text-sm flex items-center justify-center">1</span>
                            Shipping Address
                        </h2>
                        <div class="grid sm:grid-cols-2 gap-4">
                            <input v-model="form.firstName" placeholder="First Name"
                                class="px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500">
                            <input v-model="form.lastName" placeholder="Last Name"
                                class="px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500">
                            <input v-model="form.email" type="email" placeholder="Email"
                                class="sm:col-span-2 px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/50 p-6">
                        <h2 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                            <span
                                class="w-6 h-6 bg-orange-500 rounded-full text-white text-sm flex items-center justify-center">2</span>
                            Payment Method
                        </h2>
                        <div class="space-y-3">
                            <label v-for="method in paymentMethods" :key="method.id"
                                ...
                                :class="form.payment === method.id ? 'border-orange-500 bg-orange-50 dark:bg-orange-900/20' : 'border-gray-200 dark:border-gray-600 hover:border-gray-300'">
                ...
                <div class="lg:w-96">
                    <div
                        ...
                        <button @click="placeOrder" :disabled="loading"
                            class="w-full mt-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition disabled:opacity-50">
